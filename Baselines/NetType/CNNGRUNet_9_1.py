...
class CNNGRUNet_9_1(torch.nn.Module):
    ...
    def forward(self, states_G, states_S, require_init):
        ...
        for idx, (state_S, state_G) in enumerate(zip(states_S, states_G)):
            ...
            x_list = [F.relu(getattr(self, "end_fc{}".format(num))(self.h[num]), inplace=True) for num in range(6)]
