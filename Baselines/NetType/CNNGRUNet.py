...
class CNNGRUNet(torch.nn.Module):
    def __init__(self, inplanes, midplanes, outplanes, in_vector, out_vector, in_rnn, out_rnn, outdense):
        ...
        self.conv2 = nn.Conv2d(midplanes, midplanes, stride=1, kernel_size=3, padding=1, bias=False)
        self.bn2 = nn.BatchNorm2d(midplanes)

        self.conv3 = nn.Conv2d(midplanes, outplanes, stride=1, kernel_size=3, padding=1, bias=False)
